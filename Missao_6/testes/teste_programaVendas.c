...
int main(){
	...
	Venda v[1000];
	int match=0, executa=1, x=0, cnc=0,z=0;
	...
	while(1){
		...
		if(cadastro==1){
			while(1){
				...
				printf("Qtd. Estoque: "); 			scanf(" %d", &p[cont].estoque);
				printf("Preço unitário: R$"); 				scanf(" %f", &p[cont].preco);
				cont++;
			...
			do{
				while(1){
					...
					if(num==0){
						...
						char nomeArquivo[300]; //len=300 para que ele caiba o nomeArquivo + nome_Cliente
